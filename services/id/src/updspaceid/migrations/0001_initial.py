    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("suspended", "suspended"),
                            ("banned", "banned"),
                            ("migrated_unclaimed", "migrated_unclaimed"),
                        ],
                        default="migrated_unclaimed",
                        max_length=32,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant", "status"], name="usid_memb_tenant_status_idx"
                    )
                ],
                "constraints": [
                    models.UniqueConstraint(
                        fields=("user", "tenant"), name="usid_memb_user_tenant_uniq"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                (
                    "state",
                    models.CharField(
                        default=updspaceid.models.generate_token_urlsafe,
                        editable=False,
                        max_length=128,
                        primary_key=True,
                        serialize=False,
                ...
                (
                    "nonce",
                    models.CharField(
                        default=updspaceid.models.generate_token_urlsafe, max_length=128
                    ),
                ),
                (
                    "provider",
                ...
                (
                    "purpose",
                    models.CharField(
                        choices=[("link", "link"), ("login", "login")], max_length=16
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["user", "expires_at"], name="usid_session_user_exp_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.UniqueConstraint(
                        fields=("user", "provider"), name="usid_ext_user_provider_uniq"
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["expires_at"], name="usid_activation_exp_idx"),
                ],
            },
        ),
    ]
